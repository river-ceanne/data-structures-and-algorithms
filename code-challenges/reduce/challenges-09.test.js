...
const reversedString = (arr) => {
  // Solution code here...
  return arr.split('').reduce((accumulator, currValue) => currValue + accumulator);
};
...
const countNumberOfChildren = (arr) => {
  ...
  return arr.reduce(((accumulator,currValue) => {
    if(currValue.children) accumulator += currValue.children.length;
    return accumulator;
  }),0);
};
...
const calculateAverage = (arr) => {
  // Solution code here...
  let output = arr.reduce(((accumulator,currVal) => {
    accumulator.sum += currVal;
    accumulator.count++;
    return accumulator;
  }),{count: 0,sum: 0});
...
const countPrimeNumbers = (arr) => {
  // Solution code here...
  return arr.reduce(((accumulator,currVal) => {
    if(isPrime(currVal)) accumulator += 1;
    return accumulator;
  }),0);
};

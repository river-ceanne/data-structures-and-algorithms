...
const sortPeople = (arr) => {
  // Solution code here...
  arr.sort(function(a, b){
    let newA = a.lastName.toLowerCase();
    let newB = b.lastName.toLowerCase();
    if (newA < newB) {return -1;}
    if (newA > newB) {return 1;}
  }
  );
...
const sortPeopleBetter = (arr) => {
  ...
  arr.sort(function(a, b){
    ...
    if(newA === newB){
      newA = a.firstName.toLowerCase();
      newB = b.firstName.toLowerCase();
...
const sortMeetingsByDay = (arr) => {
  ...
  arr.sort(function sortByDay(a, b) {
    ...
    return weekdaySort[dayA] - weekdaySort[dayB];
  });
  return arr;
};
...
const sortSchedule = (arr) => {
  // Solution code here...
  arr.sort(function(a, b){
    let newA = a.dayOfWeek;
    let newB = b.dayOfWeek;

    if(newA === newB){
      return (a.end - a.start) - (b.end - b.start);
    }
    return weekdaySort[newA] - weekdaySort[newB];
  }
  );
